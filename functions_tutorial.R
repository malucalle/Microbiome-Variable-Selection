#######################################################################
#                                                                     #
#      functions_turorial_microbiome_variable_selection.R:                         #
#                                                                     #
#                                                                     #
#######################################################################
...
glmnet_wrapper  <-  function(result,X){
  ...
  # result: output of glmnet
  # X: abundance table or CLR transformed matrix
...
selbal_wrapper  <-  function(result, X){
  ...
  # result: list with the output of selbal
  # X: abundance table
  require(grid)
