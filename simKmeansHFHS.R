############################################################################
#   SIMULATION BASED ON HFHS-Day1 MICROBIOME DATA (with Kmeans)
#
#  You have to choose the name of the scenario parameter file 
#  (default:  namefsimul = 'ParamHFHSD1Sc1')
...
namefsimul = 'ParamHFHSD1Sc1'; #name of the file parameter scenario
simul_data <- read.csv(paste('./simulParam/',namefsimul,'.csv',sep=""));
dirWrite=paste('./ItrKmeans',namefsimul,sep=""); #name of the output folder 
dir.create(dirWrite);
